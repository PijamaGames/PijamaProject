...
prefabFactory.AddPrototype("RankingTextBox", new Vec2(7,9), new Vec2(0.5,0.5), false, ()=>{
  return [
    new ImageRenderer(new Vec2(50,0), new Vec2(1,1), 0.5),
    new ScrollBox(null, "Jugador 1 100 Jugador 2 99 Jugador 4 80 Jugador 5 75 Jugador 6 69 Jugador 7 60 Jugador 8 30 Jugador 9 25 Jugador 10 10 Jugador 11 5 Jugador 10 10 Jugador 11 5", new Vec2(0.3,0.6), true),
  ]
});
