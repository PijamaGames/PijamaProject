...
prefabFactory.AddPrototype("WaterBottom", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterbottom', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterBottomLeft", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterbottomleft', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterBottomRight", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterbottomright', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterLeft", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterleft', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterOuterBottomLeft", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterouterbottonleft', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterOuterBottomRight", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterouterbottomright', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterOuterTopLeft", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('wateroutertopleft', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterOuterTopRight", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('wateroutertopright', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterRight", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('waterright', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterTop", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('watertop', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterTopLeft", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('watertopleft', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("WaterTopRight", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('watertopright', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("Water1", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('water1', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("Water2", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('water2', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
prefabFactory.AddPrototype("Water3", new Vec2(1,1), new Vec2(0.0, 0.0), false, ()=>{
  return [
    new SpriteRenderer('water3', new Vec2(0, 0),new Vec2(1,1), false, 1, [0], waterFPS, false),
  ]
});
